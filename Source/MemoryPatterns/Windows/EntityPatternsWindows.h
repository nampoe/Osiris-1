...
struct EntityPatterns {
    [[nodiscard]] static consteval auto addClientPatterns(auto clientPatterns) noexcept
    {
        return clientPatterns
            .template addPattern<OffsetToGameSceneNode, CodePattern{"48 8B CB E8 ? ? ? ? 49 8B CD E8 ? ? ? ? 49 8B CD"}.add(12).read()>()
            ...
            .template addPattern<OffsetToVData, CodePattern{"48 8B 89 ? ? ? ? 48 85 C9 74 ? 48 8B 49 ? 48 8D 05"}.add(3).read()>()
